...
data <- read_csv("../DACSS 690V/pattern_details_cleaned.csv")
...
plot1data <- read_csv("../DACSS 690V/item_type_bar_graph.csv", show_col_types = FALSE)
```
...
plot3data <- read_csv("../DACSS 690V/price_histogram.csv", show_col_types = FALSE)
...
plot2data <- read_csv("../DACSS 690V/item_type_free_bar_graph.csv", show_col_types = FALSE)
```
...
map_data <- read_csv("../DACSS 690V/map_data.csv", show_col_types = FALSE)
